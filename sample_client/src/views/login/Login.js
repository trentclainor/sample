...
class LoginView extends React.Component {
    ...
    defaultRedirectRoute = '/search';

    constructor(props) {
        super(props);

        const redirectRoute = this.props.location ? this.extractRedirect(this.props.location.search) || this.defaultRedirectRoute : this.defaultRedirectRoute;
        this.state = {
            formValues: {
                email: '',
                password: ''
    ...
    extractRedirect = (string) => {
        ...
        return match ? match[1] : this.defaultRedirectRoute;
    };
