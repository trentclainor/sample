...
from sample.job_profiles.models import JobProfile, Language

User = get_user_model()


class LanguageViewSet(NestedModelViewSet):
    ...
    def get_queryset(self):
        if self.is_valid_parent_pk():
            return Language.objects.filter(job_profile_id=self.parent_pk)
